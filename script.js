document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('fetch-data').addEventListener('click', function() {
        ...
        if (startDateInput && endDateInput) {
            ...
            const url = `https://api.agromonitoring.com/agro/1.0/ndvi/history?start=${startDate}&end=${endDate}&polygon_id=${polygonId}&appid=${apiKey}&clouds=${clouds_min},${clouds_max}`;
